...
```
# Figure 2: Supply and Demand Relationship 
...
supply2 <- data.frame(Hmisc::bezier(c(1, 8, 9),
                                    c(1, 5, 9))) 
supply1 <-  data.frame(Hmisc::bezier(c(2.5, 9, 10),
                                    c(1, 5, 9))) 
# Supply and demand curves and arrows
econ_plot <- sdcurve(demand1, supply1, demand1, supply2,
        names = c("D[2]", "S[1]","D[1]", "S[2]"),
        linescol = c(1, 2, 1, 4)) +
  labs(x = "Quantity", y = "Price",  
       caption = "Copyright 2026 by Coastal & Marine Economics Lab, Gulf of Maine Research Institute") +
  theme(size = 14)

econ_plot

setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave("Figure_2.png", plot = econ_plot, width = 12, height = 10, units = "in", dpi = 300, bg = "white")
...
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave("Figure_3.png", plot = Regional_Figure, width = 12, height = 10, units = "in", dpi = 300, bg = "white")
...
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave("Figure_5.png", plot = landings_value_SS , width = 6, height = 4, units = "in", dpi = 300, bg = "white")
...
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave(filename = "Figure_10.jpeg", plot = landings_value_NQ, device = "jpeg", width = 6, height = 4, dpi = 300)
```
...
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave(filename = "Figure_11.jpeg", plot = landings_value_EO, device = "jpeg", width = 6, height = 4, dpi = 300)
```
...
PPPMonthScaledPounds2023 <- ggplot(STMonthSoftShell2023, aes(x = Month)) + 
  ...
  xlab("2023") +
  labs(caption = "Copyright 2026 by Coastal & Marine Economics Lab, Gulf of Maine Research Institute") +
  theme_minimal() +
...
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave(filename = "Figure_6.jpeg", plot = PPPMonthScaledPounds2023, device = "jpeg", width = 6, height = 4, dpi = 300)
```
...
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave(filename = "Figure_7.jpeg", plot = PPPMonthScaledPounds2021, device = "jpeg", width = 6, height = 4, dpi = 300)
```
...
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave(filename = "Figure_8.jpeg", plot = PPPMonthScaledPounds2015, device = "jpeg", width = 6, height = 4, dpi = 300)
```
...
year_over_year <- ggplot(total_pounds_year_percentage, aes(x = Year, y = percent_change)) +
  geom_bar(stat = "identity", fill = "#00608a") +
  geom_text(aes(label = ifelse(!is.na(percent_change), paste0(percent_change, "%"), "")),
            ...
            color = "black") +
  scale_x_date(breaks = as.Date(c("2006-01-01", "2008-01-01","2010-01-01",
...
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave(filename = "Figure_9.jpeg", plot = year_over_year, device = "jpeg", width = 8, height = 4, dpi = 300)
...
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave(filename = "Figure_12.jpeg", plot = PPPMonthBar, device = "jpeg", width = 8, height = 4, dpi = 300)
```
...
monthlyFPI_price <- ggplot(long_data, aes(x = year_month, y = Value, color = Type)) +
  ...
  theme_minimal() +
  theme(legend.position = "none", plot.caption = element_text(size = 8, color = "gray40")) 

monthlyFPI_price

# Save the plot as a JPEG file
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave(filename = "Figure_13.jpeg", plot = monthlyFPI_price, device = "jpeg", width = 6, height = 4, dpi = 300)
...
# Save the plot as a JPEG file
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave(filename = "Figure_14.jpeg", plot = monthlyFPI_price_NQ, device = "jpeg", width = 6, height = 4, dpi = 300)
...
# Save the plot as a JPEG file
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave(filename = "Figure_16.jpeg", plot = yearlyFPI_price, device = "jpeg", width = 6, height = 4, dpi = 300)
...
# Save the plot as a JPEG file
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave(filename = "Figure_15.jpeg", plot = combined_SS, device = "jpeg", width = 6, height = 4, dpi = 300)
...
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave(filename = "Figure_17.jpeg", plot = intraannual_yr, device = "jpeg", width = 8, height = 6, dpi = 300)
...
gmri_cols <- c("Stormy" = "#b94a40", "Not Stormy" = "#057872")
...
# Save the plot as a JPEG file
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave(filename = "Figure_19.jpeg", plot = StormLandings, device = "jpeg", width = 6, height = 4, dpi = 300)
...
stepfunc_plot <- ggplot(binned_data, aes(x = mean_MLLW_center, y = avg_log_pounds)) +
  geom_step(direction = "hv", color = "#00608a") +
  facet_wrap(~ Region) +
  labs(
    x = NULL,
...
tidehisto_summer <- tideheights_summer %>%   
  ggplot(aes(x = LW)) +
  geom_histogram(binwidth = 0.5, fill = "#00608a", color = "white") +
  facet_wrap(~ Region) +  
...
Combined_Plot_Summer <- summerplot / tidehisto_summer + 
  ...
  labs(caption = "Copyright 2026 by Coastal & Marine Economics Lab, Gulf of Maine Research Institute") +
  plot_annotation(
    title = "Estimated Trend of Summer Landings over Mean Low Water \nUsing Natural Splines (df = 3)",
    theme = theme(
...
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
ggsave("Figure_18.png", Combined_Plot_Summer, width = 15, height = 12, dpi = 300, bg = "white")
...
closures <- closures %>% 
  dplyr::select(ID, `Legal Notice Date`, `Growing Area`, Description)

closures$`Legal Notice Date` <- as.Date(closures$`Legal Notice Date`, format = "%m/%d/%Y")

# Expand letter ranges (e.g., WA-WD → WA, WB, WC, WD)
...
closures_expanded <- closures %>%
  separate_rows(`Growing Area`, sep = "[,;]\\s*") %>% # Split on commas OR semicolons
...
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave("Figure_20.png", p1, width = 6, height = 4, dpi = 300, bg = "white")

```

### Changes in Seasonal Timing of Closures: 2014-2024

```{r}
# Generate Seasonal Variable 
seasonal_props <- closures_expanded %>%
  rename(date = `Legal Notice Date`) %>% 
...
### Figure 21: Stacked Bar Chart for Seasonal Count of Closures 

```{r}
seasonal_props_count <- closures_expanded %>%
  rename(date = `Legal Notice Date`) %>% 
  mutate(date = as.Date(date, format = "%m/%d/%Y"),
    Season = case_when(
      month(date) %in% c(12, 1, 2) ~ "Winter",
...
setwd("C:/Users/BenCotton/Desktop/DMR_TechReport_Figures")
#ggsave("Figure_21.png", p3, width = 6, height = 4, dpi = 300, bg = "white")
